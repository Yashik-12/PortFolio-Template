...
document.addEventListener('DOMContentLoaded', function () {
  const themeSwitch = document.getElementById('theme-switch'),
    ...
    githubIcon = document.querySelector('.github'), // Replace with the actual class of your GitHub icon
    linkedinIcon = document.querySelector('.linkedin'), // Replace with the actual class of your LinkedIn icon
    body = document.body;
